...
class ShoppingCartApp$Test extends FunSuite {
  ...
  test("shopping cart with only apples calculated correctly") {
    ...
    val itemPriceCalculator: Map[String, ItemTotalCalculator] = Map("Apple" -> DefaultItemCalculator, "Orange" -> DefaultItemCalculator)
  ...
  test("buy one get one free offer applied on apples") {
    ...
    val itemPriceCalculator: Map[String, ItemTotalCalculator] = Map("Apple" -> BOGOCalculator, "Orange" -> DefaultItemCalculator)
  ...
  test("three for 2 offer applied on oranges") {
    ...
    val itemPriceCalculator: Map[String, ItemTotalCalculator] = Map("Apple" -> DefaultItemCalculator, "Orange" -> ThreeFor2Calculator)
